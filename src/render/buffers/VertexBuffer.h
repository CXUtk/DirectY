...
struct Vertex {
    ...
    glm::vec2 texCoord;
    glm::vec3 normal;
    Vertex() : pos(0), color(0), texCoord(0), normal(0) {}
    Vertex(glm::vec4 pos, glm::vec3 color, glm::vec2 texCoord, glm::vec3 normal) :pos(pos), color(color), texCoord(texCoord), normal(normal) {}
};
